...
- ⛔ `swop/cli-wrapper/codex-auth-isolation-discovery` (validate per-process account isolation; WSL/mac)
- ✅ `swop/cli-wrapper/account-sandbox-manager` (create/list/remove sandboxes; permissions)
